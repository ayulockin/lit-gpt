...
def load_lora_checkpoint(fabric: L.Fabric, model: nn.Module, checkpoint_path: Path, lora_checkpoint_path: Path, strict: bool = True) -> None:
    if isinstance(fabric.strategy, FSDPStrategy):
        raise NotImplementedError
    else:
        lora_checkpoint = lazy_load(lora_checkpoint_path)
